          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/women/Women1.jpg" alt="" />
              </a>
            </div>
            <div class="pt-6">
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/women/Women2.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/women/Women3.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/women/Women4.jpg">
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/women/Women5.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/women/Women6.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/women/Women7.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/women/women8.jpg" alt="" />
              </a>
            </div>
            <div class="pt-6">
              <div class="mb-4 flex items-center justify-between gap-4">
