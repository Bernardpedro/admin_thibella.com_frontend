          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/men/1.jpg" alt="" />
              </a>
            </div>
            <div class="pt-6">
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/men/2.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/men/3.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/men/4.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/men/5.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/men/6.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/men/7.jpg" alt="" />
              </a>
            </div>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="h-56 w-full">
              <a href="#">
                ...
                <img class="mx-auto hidden h-full dark:block" src="assets/img/men/8.jpg" alt="" />
              </a>
            </div>
            <div class="pt-6">
              <div class="mb-4 flex items-center justify-between gap-4">
