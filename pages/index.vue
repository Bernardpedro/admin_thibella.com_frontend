      ...
      <div class="mx-auto max-w-9xl lg:mx-0">
        ...
        >
          <ul class="flex flex-wrap -mb-px">
            <li class="me-2">
              <span
              @click="tab=1" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                >Women</span
              >
            </li>
            <li class="me-2" >
              <span
              @click="tab=2" class="inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg dark:text-blue-500 dark:border-blue-500"
                aria-current="page"
                >Men</span
              >
            </li>
            <li class="me-2">
              <span
              @click="tab=3" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                >Kids</span
              >
            </li>
            <li class="me-2">
