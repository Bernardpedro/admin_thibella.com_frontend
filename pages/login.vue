      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
        ...
        <form @submit.prevent="handleLogin" novalidate>
          ...
          <div class="flex items-center justify-between mb-6">
            ...
            <NuxtLink to="/forgot-password" class="text-sm text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-medium">
              Forgot password?
            </NuxtLink>
          </div>
...
const validateForm = () => {
  ...
  if (!formData.value.email.trim()) {
    ...
    isValid = false
  } else if (formData.value.email.includes('@') && !isValidEmail(formData.value.email)) {
...
const handleLogin = async () => {
  ...
  try {
    ...
    // Example: Uncomment and modify for actual API call
